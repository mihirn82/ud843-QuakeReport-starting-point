...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String geoLocation = currentEarthquake.getLocation();
        String sLocation, sDirection = "";
        if (geoLocation.contains("km")){
            //Split
            String[] parts = geoLocation.split("of ");
            sDirection = parts[0] + "of"; // direction: 88km N of
            sLocation = parts[1]; // location: California
        }
        else{
            sDirection = "Near the";
            sLocation = geoLocation;
        }
        ...
        directionTextView.setText(sDirection);
        ...
        // Get the location from the current Earthquake object and
        // set this text on the location TextView
        locationTextView.setText(sLocation);
